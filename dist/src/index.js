...
#define LOW_PRECISION`),t}function xE(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Vf?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===N_?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===as&&(t="SHADOWMAP_TYPE_VSM"),t}function vE(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case qr:case $r:t="ENVMAP_TYPE_CUBE";break;case Sl:t="ENVMAP_TYPE_CUBE_UV";break}return t}function SE(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case $r:t="ENVMAP_MODE_REFRACTION";break}return t}function ME(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Xf:t="ENVMAP_BLENDING_MULTIPLY";break;case t0:t="ENVMAP_BLENDING_MIX";break;case e0:t="ENVMAP_BLENDING_ADD";break}return t}function bE(s){let t=s.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function TE(s,t,e,n){let i=s.getContext(),r=e.defines,o=e.vertexShader,a=e.fragmentShader,l=xE(e),c=vE(e),h=SE(e),d=ME(e),f=bE(e),u=uE(e),_=dE(r),g=i.createProgram(),m,p,b=e.glslVersion?"#version "+e.glslVersion+`
