...
#define LOW_PRECISION`),t}function ob(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===pf?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Em?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===ki&&(t="SHADOWMAP_TYPE_VSM"),t}function ab(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case xs:case ys:t="ENVMAP_TYPE_CUBE";break;case Pa:t="ENVMAP_TYPE_CUBE_UV";break}return t}function lb(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case ys:t="ENVMAP_MODE_REFRACTION";break}return t}function cb(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case xf:t="ENVMAP_BLENDING_MULTIPLY";break;case Wm:t="ENVMAP_BLENDING_MIX";break;case Xm:t="ENVMAP_BLENDING_ADD";break}return t}function hb(r){let t=r.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function ub(r,t,e,n){let i=r.getContext(),s=e.defines,o=e.vertexShader,a=e.fragmentShader,l=ob(e),c=ab(e),h=lb(e),d=cb(e),u=hb(e),f=jS(e),_=QS(s),g=i.createProgram(),m,p,S=e.glslVersion?"#version "+e.glslVersion+`
